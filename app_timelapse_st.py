...
def day_night_evening_percent(timelapse_file_path):
    ...
    st.write("day percentage:",day_frames_percent)
    st.write("night percentage:",night_frames_percent)
    st.write("evening/early morning percentage:",evening_frames_percent)
